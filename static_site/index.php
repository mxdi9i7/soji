<?php include './partials/header.php' ?>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
      <div class="divimage dzsparallaxer--target w-100 g-bg-pos-bottom-center" style="height: 120%; background-image: url(assets/banner/2.jpg);"></div>

      <div class="container g-py-200">
        <div class="row">
          <div class="col-md-6">
            <h3 class="g-color-black g-font-weight-300 g-font-size-40 g-line-height-1_2 mb-4">Outsource your work<br>to Soji
              </h3>
            <span class="d-block g-color-black-opacity-0_8 g-font-size-16 mb-5">Instruct, manage and enjoy a peace of mind.</span>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 g-bg-img-hero g-pos-rel" style="background-image: url(assets/img/maps/map3.png);">
            <div class="g-absolute-centered text-center w-100 g-px-40">
              <h2 class="h1 g-color-gray-light-v2 g-font-weight-600 g-letter-spacing-0_5">Soji is
      ...
      <div class="container">
        <header class="g-mb-50">
          <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
            <h2 class="h4 u-heading-v2__title g-color-gray-dark-v2 g-font-weight-600 text-uppercase">Our Recent Clients</h2>
          </div>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
      <!-- Parallax Image -->
      <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-img-hero g-bg-white-opacity-0_7--after" style="height: 140%; background-image: url(assets/banner/1.jpg);"></div>
      <!-- End Parallax Image -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 align-self-center g-pl-30--lg">
            <header class="g-mb-30">
              <div class="u-heading-v2-3--bottom g-brd-primary g-mb-30">
                <h2 class="h4 u-heading-v2__title g-color-gray-dark-v2 g-font-weight-600 text-uppercase">Our Offshore Team</h2>
              </div>
              <p class="g-font-size-16">Soji
      ...
      <div class="container">
        <div class="row text-center text-uppercase">
          <div class="col-lg-3 col-sm-6 g-brd-right g-brd-gray-light-v4 g-mb-50">
            ...
            <h4 class="h6 g-color-gray-dark-v5">Active Clients</h4>
          </div>
          ...
          <div class="col-lg-3 col-sm-6 g-brd-right--lg g-brd-gray-light-v4 g-mb-50">
            ...
            <h4 class="h6 g-color-gray-dark-v5">Employees</h4>
          </div>

          <div class="col-lg-3 col-sm-6 g-brd-right g-brd-gray-light-v4 g-mb-50">
            <div class="js-counter g-color-gray-dark-v2 g-font-size-35 g-font-weight-300 g-mb-7">7348</div>
            <h4 class="h6 g-color-gray-dark-v5">Locations</h4>
          </div>
          ...
          <div class="col-lg-3 col-sm-6 g-mb-50">
            ...
            <h4 class="h6 g-color-gray-dark-v5">Jobs Finished</h4>
          </div>
        </div>
      </div>
    </section>
